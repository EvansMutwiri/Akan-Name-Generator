function submission() {
  ...
  if (dd <= 0 || dd > 31) {
    ...
    Math.round(result) == 1 ||
    (Math.round(result) == -1 && gender === "female")
  ) {
    document.getElementById("final").innerHTML =
      "You were born on Monday, your Akan Name is " + femaleNames[1];
  } else if (
    Math.round(result) == 2 ||
    (Math.round(result) == -2 && gender === "female")
  ) {
    document.getElementById("final").innerHTML =
      "You were born on Tuesday, your Akan Name is " + femaleNames[2];
  } else if (
    Math.round(result) == 3 ||
    (Math.round(result) == -3 && gender === "female")
  ) {
    document.getElementById("final").innerHTML =
      "You were born on Wednesday, your Akan Name is " + femaleNames[3];
  } else if (
    Math.round(result) == 4 ||
    (Math.round(result) == -4 && gender === "female")
  ) {
    document.getElementById("final").innerHTML =
      "You were born on Thursday, your Akan Name is " + femaleNames[4];
  } else if (
    Math.round(result) == 5 ||
    (Math.round(result) == -5 && gender === "female")
  ) {
    document.getElementById("final").innerHTML =
      "You were born on Friday, your Akan Name is " + femaleNames[5];
  } else if (
    Math.round(result) == 6 ||
    (Math.round(result) == -6 && gender === "female")
  ) {
    document.getElementById("final").innerHTML =
